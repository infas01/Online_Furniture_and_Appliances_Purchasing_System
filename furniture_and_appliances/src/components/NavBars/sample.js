...
export default () => {
    ...
    return (
        <>
            <nav className={`relative z-20 bg-white w-full md:static md:text-sm md:border-none ${state ? 
                "shadow-lg rounded-b-xl md:shadow-none" : ""}`}>
                <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="javascript:void(0)">
                            <img
                                src="https://scontent.fcmb10-1.fna.fbcdn.net/v/t39.30808-6/300778899_433149192166044_8459057536553482366_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=a2f6c7&_nc_eui2=AeFeeFM5IjkxpEFqm_5R7IaO9FLp743uWKv0Uunvje5Yq-DkwnXjGTY0Iiy5jngVEE6TxY8v5ANTJAlMtt_klE_y&_nc_ohc=qbFMFjWgrqoAX_akRTq&_nc_ht=scontent.fcmb10-1.fna&oh=00_AfAcgC6Z5OpHibOXkXUtXsr82j2Corp7meb0KQJrCYy8WA&oe=64FFF661"
                                width={40}
                                height={40}
                                alt="Float UI logo"
                            />
